	...
	<view>
		<view class="wrap">
			<view class="u-tabs-box">
				<u-tabs-swiper activeColor="#00aa00" ref="tabs" :list="list" :current="current" @change="change" :is-scroll="false"
...
<style lang="scss" scoped>
	...
	.centre {
		...
		.btn {
			...
			color: #ffffff;
			font-size: 26rpx;
			background: linear-gradient(270deg, rgba(99, 204, 91, 1) 0%, rgba(11, 182, 131, 1.0) 100%);
		}
	}
